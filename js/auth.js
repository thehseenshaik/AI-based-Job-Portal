...
// ---------- password toggle ----------
(function(){
  var t=document.getElementById('pwToggle'), pw=document.getElementById('password');
  if(!t||!pw) return;
  t.addEventListener('click',function(){
    ...
    t.innerHTML=show
      ? '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M2 12s3.5-7 10-7 10 7 10 7-3.5 7-10 7-10-7-10-7z"/><circle cx="12" cy="12" r="3"/><line x1="3" y1="3" x2="21" y2="21"/></svg>'
